<template>
  <div>
    ...
    <div style="height: 550px;width:60%;margin: 0 auto;" v-loading="loading">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">{{routerName}}</el-breadcrumb-item>
        <el-breadcrumb-item>项目详情</el-breadcrumb-item>
      </el-breadcrumb>
      <h3>项目基本信息</h3>
    <div style="height: 550px;width:100%;position: relative;margin: 50px auto;">
...
export default {
  ...
  data () {
    return {
      ...
      Mid: '',
      duration: 0,
      modId: this.$route.params.modelId,
      btnShow: false,
      projectUID: '',
      ruleForm: {
        projectName: '',
